...
export interface Post {
  ...
  /**
   * Freeform tags. Rendered as chips on the post.
   */
  tags?:
    | {
        tag: string;
...
export interface User {
  ...
  /**
   * Optional. Shown on the author byline.
   */
  walletAddress?: string | null;
  /**
   * Optional Farcaster handle, without the leading @.
   */
  farcaster?: string | null;
  /**
   * Optional X handle, without the leading @.
   */
  x?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface CodeBlock {
  language?: ('typescript' | 'javascript' | 'json' | 'bash' | 'solidity' | 'sql' | 'text') | null;
  code: string;
  id?: string | null;
